package com.tcll.core.snmp.win;
...
public class MonitorFactory{
	...
	private Logger log = LoggerFactory.getLogger(MonitorFactory.class);
...
//				log.info("line=" + line);
	...
	public static void main(String[] args) throws Exception {
		MonitorFactory service = new MonitorFactory();
