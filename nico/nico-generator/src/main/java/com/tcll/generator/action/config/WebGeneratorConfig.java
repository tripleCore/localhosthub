...
import com.tcll.generator.action.model.GenQo;
import com.tcll.generator.utils.StrKit;
import com.tcll.generator.utils.ToolUtil;
...
public class WebGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void config() {
        ...
        //model dao位置变为动态
        //com.yondervision.cpms.admin.common.persistence.model
        contextConfig.setModelMapperPackageName(contextConfig.getProPackage() + ".modular." + contextConfig.getModuleName() + ".dao");
        contextConfig.setModelPackageName(contextConfig.getProPackage() + ".modular." + contextConfig.getModuleName() + ".model");
        //model dao位置变为动态
