package com.tcll.generator.engine.config;
...
public class ContextConfig {
    ...
    private String proPackage = "com.yondervision.cpms.admin";
    private String coreBasePackage = "com.tcll.core";
    private String modelPackageName = "com.yondervision.cpms.admin.common.persistence.model";        //model的包名
    private String modelMapperPackageName = "com.yondervision.cpms.admin.common.persistence.dao";  //model的dao
